...
public class StudentServiceImplTest {
    ...
    public void testGetAllStudents() {
        ...
        studentList.add(new Student(1, "badsna", "badsnastha@gmail.com", Gender.FEMALE, 21, Status.ACTIVE, addressList.get(0)));
        studentList.add(new Student(2, "adsna", "adsnastha@gmail.com", Gender.FEMALE, 20, Status.DEACTIVE, addressList.get(1)));
    ...
    public void testGetStudentByIdWithIdExists() {
        ...
        Student student = new Student(1, "badsna", "badsnastha@gmail.com", Gender.FEMALE, 21, Status.ACTIVE, address);

        when(studentRepo.findById(1)).thenReturn(Optional.of(student));
        //Deep Check==>checks the value inside the object
        assertThat(student, samePropertyValuesAs(objectMapper.convertValue(studentService.getStudentById(1), Student.class)));

        //Shallow Check==>checks the reference of the object
        //assertEquals(student.getName(), objectMapper.convertValue(studentService.getStudentById(1),Student.class).getName());
    }

    @Test
    public void testAddNewStudentWithEmailAlreadyExists() {
        Address oldAddress = new Address(1, "benepa", "nala");
        StudentRequestDto oldStudent = new StudentRequestDto("badsna", "badsnastha@gmail.com", Gender.FEMALE, 21, oldAddress);

        Address newAddress = new Address(1, "benepa", "nala");
        StudentRequestDto newStudent = new StudentRequestDto("badsna", "badsnastha@gmail.com", Gender.FEMALE, 21, newAddress);
    ...
    public void testAddNewStudentWithEmptyNameField() {
        Address newAddress = new Address(1, "benepa", "nala");
        StudentRequestDto newStudent = new StudentRequestDto("", "badsnastha@gmail.com", Gender.FEMALE, 21, newAddress);
    ...
    public void testAddNewStudentWithNullNameField() {
        Address newAddress = new Address(1, "benepa", "nala");
        StudentRequestDto newStudent = new StudentRequestDto(null, "badsnastha@gmail.com", Gender.FEMALE, 21, newAddress);
    ...
    public void testUpdateStudentWithIdDoesntExits() {
        ...
        StudentRequestDto updateStudent = new StudentRequestDto("adsna", "adsna@gmail.com", Gender.FEMALE, 20, updateAddress);
    ...
    public void testUpdateStudentWithIdExists() {
        ...
        Student existingStudent = new Student(1, "badsna", "badsnastha@gmail.com", Gender.FEMALE, 21, Status.ACTIVE, existingAddress);
